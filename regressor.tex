...
\caption{  \label{fig:aicwords}  
  {\sl Corrected AIC statistics for regression models that add words in the order of decreasing (solid) or decreasing (dashed) frequency.}  The vertical gray segment identifies the model that minimizes $AIC_c$.}
